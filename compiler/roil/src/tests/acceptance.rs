...
mod parser {
    use crate::parser::{Parser, Item};
    use crate::symtab::SymTab;

    pub fn parse_from_str(input: &str) -> Item {
        let mut p = Parser::new(input);
        let mut st = SymTab::new();

        p.g_statement(&mut st)
    }

    #[test]
    fn integers() {
        let result = parse_from_str("42");
        assert_eq!(result, Item::ConstInteger(42));

        let result = parse_from_str("420");
        assert_eq!(result, Item::ConstInteger(420));

        let result = parse_from_str("49_152");
        assert_eq!(result, Item::ConstInteger(49152));

        let result = parse_from_str("0xC000");
        assert_eq!(result, Item::ConstInteger(49152));

        let result = parse_from_str("0q10");
        assert_eq!(result, Item::ConstInteger(8));

        let result = parse_from_str("010");
        assert_eq!(result, Item::ConstInteger(8));

        let result = parse_from_str("080");
        assert_eq!(result, Item::ConstInteger(80));

        let result = parse_from_str("-42");
        assert_eq!(result, Item::ConstInteger(0xFFD6));
    }
...
//
//        let result = parse_from_str("let x = 0");
//        assert_eq!(result, Ok(vec![Ins::StoreZeroDP(dp_locals), Ins::Return,]));
//
//        let result = parse_from_str("begin let x = 0");
//        assert_eq!(result, Ok(vec![Ins::StoreZeroDP(dp_locals), Ins::Return,]));
//
//        let result = parse_from_str("begin let x = 1; let y=2");
//        assert_eq!(
//            result,
//            Ok(vec![
//                Ins::LoadAImm16(1),
...
//        let dp_locals = dp_result + 2;
//
//        let result = parse_from_str("begin let x=1; let y=2; x+y-2");
//        assert_eq!(
//            result,
//            Ok(vec![
//                Ins::LoadAImm16(1),
...
//        let dp_locals = dp_result + 2;
//
//        let result = parse_from_str("begin let x=0; x: x + 20");
//        assert_eq!(
//            result,
//            Ok(vec![
...
//        );
//
//        let result = parse_from_str("begin let x=0; let y=0; y: x: x + 20");
//        assert_eq!(
//            result,
//            Ok(vec![
//                Ins::StoreZeroDP(dp_locals),
